...
# Check if GPU is available, change the device to gpu
device = torch.device("cuda") if torch.cuda.is_available() else torch.device("cpu")

# Set MLflow tracking URI to the local instance
mlflow_tracking_uri = os.getenv("MLFLOW_TRACKING_URI", "http://127.0.0.1:5000")
mlflow.set_tracking_uri(mlflow_tracking_uri)
mlflow.set_experiment("ALBERT Sentiment Analysis Evaluation")
...
gcs_test_data_path = "gs://amazon_sentiment_analysis/albert/processed_data/final_cleaned_data/test_albert_amazon_reviews.csv"
